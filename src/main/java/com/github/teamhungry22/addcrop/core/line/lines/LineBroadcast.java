...
public class LineBroadcast extends AbstractLine {
    public LineBroadcast(Map<String, String> stringMap, boolean containsPAPI) {
        super(stringMap, containsPAPI);
        throw new AddCropNotFoundException();
    }

    public static LineBroadcast build(Map<String, String> stringMap) {
        throw new AddCropNotFoundException();
    }

    private static LineBroadcast parseLine(Map<String, String> stringMap) {
        throw new AddCropNotFoundException();
    }
